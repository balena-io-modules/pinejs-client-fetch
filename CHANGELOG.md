...
* Tests: fix tsconfig checks [Pagan Gazzard]
* Tests: reuse `AnyObject` from pinejs-client-core rather than redefining [Pagan Gazzard]
...
* Fix year and owner in license [joshbwlng]
...
* Leave the error message as-is to stay closer to other implementations [Pagan Gazzard]
...
* Avoid issues with non-JSON responses [Pagan Gazzard]

## 2.0.1 - 2025-09-18

* Fix missing content-type header with JSON bodies [Pagan Gazzard]
